...
from apps.accounts import choices as accounts_choices


class User(AbstractBaseUser, common_models.TimeStampModel, PermissionsMixin):
    username = models.CharField(
        max_length=30, unique=True, null=True, blank=True, verbose_name=_("Username")
    )
    ...
    gender = models.CharField(
        max_length=20, 
        choices=accounts_choices.UserGenderChoices.CHOICES,
        blank=True,
        null=True, 
    ...
    profile_picture = models.ImageField(
        default="default.jpg", 
        upload_to=common_utils.users_profile_upload_path, 
        blank=True, 
        null=True, 
...
class UserAddress(common_models.TimeStampModel):
    ...
    alternate_email = models.EmailField(_("Email address"), unique=True, null = True, blank=True,)
    mobile_regex = RegexValidator(
        regex=r'^\d{9,17}$', 
        message="Phone number must be entered in the format: '9999999999'. Up to 16 digits allowed."
    )
    ...
    address_1 = models.CharField(max_length=64, verbose_name=_("Address 1"))
